...
export const ASIAN_DISH = [
  ...
  },
  {
    id: uuidv4(),
    image: meatRice,
    title: "Chicken, Rice and Cabbage",
    price: 20.99,
    description:
...

  {
    ...
    price: 18.99,
    description:
      "Pork Vindaloo is one of the easiest Indian meals you can cook in your kitchen.        The pork is marinated first in vibrant and tangy hot vindaloo paste and later slow cooked along with caramelized onions for hours.Result? Melt in you mouth deliciousness.",
  },
  {
    id: uuidv4(),
    image: shanghai,
  ...
  },
  {
    id: uuidv4(),
    image: boLuc,
    title: "Bò Lúc Lắc (Vietnamese Beef)",
    price: 24.99,
    description:
